          ...
          <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50">
            <div className="p-2">
              ...
              {networks.map((network) => (
                <button
                  ...
                  disabled={isSwitching}
                  className={`w-full flex items-center space-x-3 px-3 py-2 rounded-md transition-colors text-left disabled:opacity-50 disabled:cursor-not-allowed ${
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-2">
              <div className="text-xs text-gray-500 dark:text-gray-400 px-3 py-2">
                Network switching requires MetaMask approval
              </div>
            </div>
          </div>
        </>

...
const ProfitCalculator: React.FC = () => {
  ...
  const calculateProfit = () => {
    const { priceA, priceB, tradeAmount, gasPrice, gasLimit, slippage } =
      inputs;
    ...
    const grossProfitBeforeSlippage =
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setInputs((prev) => ({ ...prev, tokenPair: e.target.value }))
              }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInputs((prev) => ({
                    ...prev,
                    priceA: parseFloat(e.target.value) || 0,
                  }))
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInputs((prev) => ({
                    ...prev,
                    priceB: parseFloat(e.target.value) || 0,
                  }))
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setInputs((prev) => ({
                    ...prev,
                    gasLimit: parseFloat(e.target.value) || 0,
                  }))
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
              />
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xl font-bold ${result.netProfit > 0 ? "text-green-500" : "text-red-500"}`}
                    >
